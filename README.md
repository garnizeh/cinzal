...
|---|---|---|
| [`docs/project/cinzal-gdd.md`](docs/project/cinzal-gdd.md) | Game Design Document, v2.8 | Authoritative on **rules** |
| [`docs/project/cinzal-architecture-rfc.md`](docs/project/cinzal-architecture-rfc.md) | Architecture RFC-001, r11 | Authoritative on **architecture** |
...
Go 1.23+ · [templ](https://templ.guide) · HTMX 2.x + SSE · [sqlc](https://sqlc.dev) · [goose](https://github.com/pressly/goose) · pgx/v5 · Postgres 16
