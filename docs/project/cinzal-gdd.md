...
**Tier mix of an offer (D6).** One of the three is always drawn from your **highest currently eligible tier** — eligibility uses your Infamy at Phase 2, the same moment that gates the Contact Cooldown (§11.1). The other two are drawn independently from your eligible tiers, on an even split by default. This is what makes climbing the ladder pay off in fact and not just in expectation: every offer to a Known, Feared or Legend player includes a shot at the tier their Infamy just bought them, not three more Tier I jobs at long odds against ever seeing the one they climbed for.
