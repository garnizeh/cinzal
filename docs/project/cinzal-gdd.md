...
>
> **Changelog v2.29 → v2.30** — §20's R7 remedy dials are rejected on measurement (issue [#280](https://github.com/garnizeh/cinzal/issues/280), [D42](../decisions/D42-r7-two-player-remedies-rejected.md))
