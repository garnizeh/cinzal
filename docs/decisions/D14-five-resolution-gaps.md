...
- **GDD §12, §14.2, §14.3 and §15 need no textual change.** This decision closes gaps between sections that were each individually already correct; none of the five rulings contradicts a stated rule, and none required rewriting a card's printed effect.
