...
| [D6](D06-contract-tier-mix.md) | The contract offer has no tier distribution | **decided** — one slot guarantees the highest eligible tier; the other two are a weighted draw over eligible tiers, default uniform |
