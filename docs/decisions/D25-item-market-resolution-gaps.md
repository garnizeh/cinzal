...
- **#66's acceptance criteria need correcting**, not just implementing: *"on even rounds only, per #41"* is wrong and should read *"on odd rounds (1, 3, 5, …, 15)"* with no citation to #41, since #41/D3 never made that claim.
