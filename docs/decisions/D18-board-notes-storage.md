...
- **M3's schema migration** (roadmap §4) gains `board_notes` named directly, no longer folded into the undifferentiated "D18–D19 additions" placeholder (line 317). D19 — email preferences — remains open and still needs its own decision.
