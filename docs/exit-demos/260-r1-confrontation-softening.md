...
| 10/11 — confrontations per match | 5.7465 (2p), 17.3502 (4p), 26.1498 (5p) | 5.7813 [5.7455, 5.8171] (2p); 17.4158 [17.3604, 17.4712] (4p); 26.1435 [26.0814, 26.2056] (5p) | **Matches.** Every predicted point sits inside or at the edge of the measured interval. |
| 17 — rounds flagged Loitering | 4.17% (4p), 4.98% (5p), fails > 15% | 4.25% [4.20%, 4.30%] (4p); 5.12% [5.07%, 5.17%] (5p) | **Small, consistent miss** — measured sits 0.02–0.14 pp above D39's predicted interval at both player counts, well inside the target band and nowhere near the 15% failing line, but a real (non-overlapping) gap unlike the rows above. Likely a second-order consequence of the same rule-timing sensitivity that moves row 1's residual gap between the shipped-old and E+-predicted readings (see below) — not investigated further here, since it changes no verdict. |
